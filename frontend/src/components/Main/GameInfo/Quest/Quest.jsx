              ...
              <div className="card-body pb-0">
                <div className="news">
                  <div className="post-item clearfix">
                    ...
                    <p>
                      <b>00 : 00 : 00</b><span style={{color: "whitesmoke"}}> Level {card.level}</span>
                    </p>
                    <span style={{color: "gold", fontFamily: "fantasy", fontSize: "medium"}}>{card.reward} xp</span><button id="followbtn">Enter</button>
                  </div>
                </div>
              </div>
            </div>
