 ...
 * @since 2.7.0
 */
export declare function isNullOrUndef(
  value: unknown,
 ...
 */
export declare function finiteOrDefault(
  value: unknown,
  defaultValue: number,
): number;
/**
 ...
 */
export declare function valueOrDefault<T>(
  value: T | undefined,
  defaultValue: T,
): T;
export declare const toPercentage: (
  value: number | string,
  dimension: number,
) => number;
export declare const toDimension: (
  value: number | string,
  dimension: number,
) => number;
/**
...
export declare function callback<
  T extends (this: TA, ...restArgs: unknown[]) => R,
  TA,
  R,
>(fn: T | undefined, args: unknown[], thisArg?: TA): R | undefined;
/**
 ...
 */
export declare function each<T, TA>(
 ...
 * @private
 */
export declare function _elementsEqual(
  a0: ActiveDataPoint[],
  a1: ActiveDataPoint[],
): boolean;
/**
 ...
 * @private
 */
export declare function _merger(
  key: string,
  target: AnyObject,
  source: AnyObject,
  options: AnyObject,
...
export declare function merge<T, S1>(
  target: T,
  source: S1,
  options?: MergeOptions,
): T & S1;
...
export declare function merge<T, S1, S2>(
  target: T,
  source: [S1, S2],
  options?: MergeOptions,
): T & S1 & S2;
export declare function merge<T, S1, S2, S3>(
  target: T,
  source: [S1, S2, S3],
  options?: MergeOptions,
): T & S1 & S2 & S3;
export declare function merge<T, S1, S2, S3, S4>(
  target: T,
  source: [S1, S2, S3, S4],
  options?: MergeOptions,
): T & S1 & S2 & S3 & S4;
...
export declare function mergeIf<T, S1>(target: T, source: [S1]): T & S1;
export declare function mergeIf<T, S1, S2>(
  target: T,
  source: [S1, S2],
): T & S1 & S2;
export declare function mergeIf<T, S1, S2, S3>(
  target: T,
  source: [S1, S2, S3],
): T & S1 & S2 & S3;
export declare function mergeIf<T, S1, S2, S3, S4>(
  target: T,
  source: [S1, S2, S3, S4],
): T & S1 & S2 & S3 & S4;
 ...
 * @private
 */
export declare function _mergerIf(
  key: string,
  target: AnyObject,
  source: AnyObject,
): void;
 ...
 * @private
 */
export declare function _deprecated(
  scope: string,
  value: unknown,
  previous: string,
  current: string,
