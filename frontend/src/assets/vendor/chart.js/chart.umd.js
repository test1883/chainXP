...
!(function (t, e) {
        ...
        for (let f = e; f < e + i; f++) {
          const e = this.getParsed(f),
            ...
            m = {
              ...
              base: i.base,
              enableBorderRadius:
                !p || Fn(e._custom) || a === p._top || a === p._bottom,
              x: h ? i.head : g.center,
              y: h ? g.center : i.head,
      ...
      const n = (function (t, e) {
        ...
        for (
          ...
          (u && M !== a
            ? (i.push({ value: a }),
              M < a && D++,
              V(Math.round((M + D * S) * v) / v, a, po(a, y, t)) && D++)
            : M < a && D++);
          D < k;
          ++D
        ) {
    ...
    determineDataLimits() {
      ...
      (this.min = a(t) ? Math.max(0, t) : null),
        ...
        this._zero &&
          ...
          !a(this._userMin) &&
          (this.min =
            t === _o(this.min, 0) ? _o(this.min, -1) : _o(this.min, 0)),
        this.handleTickRangeOptions();
    }
    handleTickRangeOptions() {
    ...
    t.setCenterPoint(e.l - i.l, i.r - e.r, e.t - i.t, i.b - e.b),
      (t._pointLabelItems = (function (t, e, i) {
        ...
        for (let o = 0; o < n; o++) {
          ...
          const n = Co(t, o, l);
          s.push(n),
            "auto" === r && ((n.visible = Oo(n, h)), n.visible && (h = n));
        }
        return s;
      })(t, s, o));
  }
          ...
          (i.autoSkip
            ...
            : (function (t, e, i, s, n) {
                for (let o = Ro.length - 1; o >= Ro.indexOf(i); o--) {
                  const i = Ro[o];
                  if (Eo[i].common && t._adapter.diff(n, s, i) >= e - 1)
                    return i;
                }
  ...
  function ia(t, e) {
    ...
    return (
      ...
      i.length
        ? new so({ points: i, options: { tension: 0 }, _loop: s, _fullLoop: s })
        : null
    );
  }
  function sa(t) {
      ...
      (function (t, e) {
        ...
        t.save(),
          "x" === l &&
            o !== n &&
            (da(t, s, a.top),
            ua(t, { line: i, target: s, color: n, scale: r, property: l }),
            t.restore(),
            t.save(),
            da(t, s, a.bottom));
    ...
    afterDatasetsUpdate(t, e, i) {
      ...
      for (a = 0; a < s; ++a)
        (o = t.getDatasetMeta(a)),
          ...
          n.push(l);
      for (a = 0; a < s; ++a)
        (l = n[a]), l && !1 !== l.fill && (l.fill = na(n, a, i.propagate));
    },
    beforeDraw(t, e, i) {
