 ...
 * @returns {number | null}
 */
export function _getTargetPixel(
 ...
 */
export function _getTargetValue(
  fill: FillTarget | ComplexFillTarget,
  scale: Scale,
  startValue: number,
): number | undefined;
...
export type ComplexFillTarget =
  import("../../types/index.js").ComplexFillTarget;
