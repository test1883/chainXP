...
interface Gateway {
    function createProfile(uint256 userId, string memory profile, address owner, string memory name, string memory bio, string memory country) external view returns(bytes memory sig);
